const CELULAR_EMPRESA = '555198185967';
...
cardapio.metodos = {
    ...
    obterItensCardapio: (categoria = 'acais') => {
        var filtro = Itens[categoria];
...
cardapio.templates = {
    ...
    <div class="itemCarrinho" id="item-carrinho_\${id}_\${idCarrinho}">
        ...
        <div class="col-12 acrescimos animated bounceInDown" id="acrescimos-\${idCarrinho}">
                <p class="title-produto"><b>Complementos grátis</b></p>
                ...
                <p class="title-produto especial"><b>Complementos pagos</b></p>
